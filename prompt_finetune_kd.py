...
from model.full_promp_noMLP_noPrompt import id_prompt_no_prompt
from model.full_prompt_KD import id_prompt_KD, id_prompt_KD_no_both, id_prompt_KD_no_prompt
...
def finetune(model_name, dataset, pretrained_file='', finetune_mode='', **kwargs):
    ...
    prompt_model = id_prompt_KD(config_A, pretrain_data_A.dataset, model_A).to(config['device'])
    prompt_model.pq_codes.to(config['device'])
    #模型参数freeze，pq_codes参数不freeze
    for _ in prompt_model.vqrecKD.parameters():
        _.requires_grad = False
    for _ in prompt_model.vqrecKD.pq_code_embedding_specific.parameters():
...
if __name__ == '__main__':
    p = "save_OP/VQRecKD-Jul-08-2025_08-23-46.pth" # kdw=0.2single后 OP/P
    p = "save_OP/VQRecKD-Jul-10-2025_07-47-07.pth" # kdw=0.2single后 OP/O
    # p = 'save_OP/VQRecKD-P-10-2025-07-08-kdw0.2.pth' # OP/P
    # p = 'save_OP/VQRecKD-O-10-2025-07-08-kdw0.2.pth' #OP/O
