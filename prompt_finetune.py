...
from model.full_promp_noMLP_noPrompt import id_prompt_no_prompt, id_prompt_no_both
...
def finetune(model_name, dataset, pretrained_file='', finetune_mode='', **kwargs):
    ...
    prompt_model = id_prompt_no_both(config_A, pretrain_data_A.dataset, model_A).to(config['device'])
...
if __name__ == '__main__':
    ...
    p = f"save_OP/VQRec-Jul-04-2025_01-35-27.pth" #全量后OP/P。
    p = "save_OP/VQRec-Jul-10-2025_05-52-13.pth" #全量后OP/O。


    p = "save_OA/VQRec-Jul-11-2025_01-39-52.pth" #全量后OA/O。
    # OP 😁 下方为未全量
    # p = "save_OP/VQRec-P-10-2025-06-29-e0.3-nb8.pth" 
    # p = "save_OP/VQRec-O-10-2025-06-29-e0.3-nb8.pth"
    # OA 😁
    # p = "save_OA/VQRec-A-10-2025-07-10.pth"
    p = "save_OA/VQRec-O-10-2025-07-10.pth" 
